...
FROM_ADDR = os.environ.get("SES_FROM") or "Donte Willis <hello@revenueripple.org>"
...
PHYSICAL = os.environ.get("EMAIL_PHYSICAL_ADDRESS") or "Revenue Ripple, Attn: Donte Willis"
